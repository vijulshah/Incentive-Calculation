...
public class Enter_StdWtPerHour extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			String psQuery = "insert into  DEFINED_STD_WT_PER_HOUR values (?)";
			...
			if(std_value!=null)
			{
				...
				ps.close();
				con.close();
				request.setAttribute("action_result", "Std wt per hour :<br>"+std_value+" saved");
