...
public class Enter_StdTimePerLot extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try
		{
			...
			String psQuery = "insert into DEFINED_STD_TIME_PER_LOT values (?)";
			...
			if(std_value!=null)
			{
				...
				ps.close();
				con.close();
				request.setAttribute("action_result", "Std time per lot :<br>"+std_value+" saved");
